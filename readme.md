<!-- Banner -->
[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Roboto&weight=600&size=40&duration=2000&pause=1000&color=1A58F7FF&vCenter=true&width=870&lines=Hi+I'm+Lamidu+Rathnayake;Front-End+Developer+With+React%2C+Next;Gsap+And+Threejs+Animation+Developer;Back-End+developer+with+Asp.net+core+)](https://git.io/typing-svg)



## 🚀 About Me  
I'm a passionate **in front-end developmet with animation using react, gsap, three.js and java .net based projects** also who loves exploring new technologies, building modern applications, and continuously improving my skills.
...
## 🛠️ Tech Stack
<p align="center">
  <img src="https://skillicons.dev/icons?i=java,js,ts,py,cs,dotnet,react,nextjs,threejs,nodejs,tailwind,mysql,vscode,visualstudio,figma,windows&perline=8" />
</p>
